...
from models import GroundedSAMOnnx, GroundingDino
...
def inference(data):
    ...
    sam2_encoder_model_path = "lpcvc_track2_models/sam2.1_hiera_base_plus_encoder.onnx"
    sam2_decoder_model_path = "lpcvc_track2_models/decoder.onnx"

    model = GroundedSAMOnnx(grounding_dino_model, sam2_encoder_model_path, sam2_decoder_model_path)
