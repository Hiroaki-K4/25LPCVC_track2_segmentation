...
def convert_torch_to_onnx_local(
    model,
    image_input,
    text_input,
    ...
    if test_onnx_model_local:
        ...
        onnx_model = onnxruntime.InferenceSession(
            f"{output_path}/model.onnx", providers=providers
        )
        onnx_inputs = {
...
def compile_and_profile_aihub(
    model_path="./compile_and_profile/onnx/model.onnx",
...
if __name__ == "__main__":
    ...
    model = compile_and_profile_aihub(
        model_path="./compile_and_profile/onnx/model.onnx"
    )
