...
def load_data(image_id: Optional[int] = None):
    ...
    for annotation in tqdm(annotations["annotations"]):
        ...
        texts = [
            v
            for v in annotation["attributes"].values()
...
def inference(data):
    GROUNDING_DINO_CONFIG_PATH = "./configs/groundingdino/GroundingDINO_SwinB_cfg.py"
    GROUNDING_DINO_CHECKPOINT_PATH = (
        "./lpcvc_track2_models/groundingdino_swinb_cogcoor.pth"
    )
